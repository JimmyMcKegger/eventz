...
class User
  ...
  module GeneratedAssociationMethods
    ...
    sig { returns(T::Array[T.untyped]) }
    def liked_event_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def liked_event_ids=(ids); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :liked_events, through: :likes`.
    # 🔗 [Rails guide for `has_many_through` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-through-association)
    sig { returns(::Event::PrivateCollectionProxy) }
    def liked_events; end

    sig { params(value: T::Enumerable[::Event]).void }
    def liked_events=(value); end
    ...
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :registrations`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
