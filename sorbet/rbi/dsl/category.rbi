...
class Category
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Category` class because it declared `has_many :categorizations`.
    ...
    # This method is created by ActiveRecord on the `Category` class because it declared `has_many :events, through: :categorizations`.
